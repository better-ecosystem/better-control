...
from better_control.tools.bluetooth import (
...
from better_control.ui.widgets.bluetooth_device_row import BluetoothDeviceRow
...
class BluetoothTab(Gtk.Box):
    ...
    def on_disconnect_clicked(self, button, device_path):
        ...
        from better_control.tools.bluetooth import disconnect_device_async
    ...
    def on_forget_clicked(self, button, device_path):
        ...
        from better_control.tools.bluetooth import forget_device_async
